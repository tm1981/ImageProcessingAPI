...
var ifImageExists = function (imageName, folder) { return __awaiter(void 0, void 0, void 0, function () {
    var path, _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                path = "./src/images/" + folder + "/" + imageName + ".jpg";
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
...
var checkWidthHeight = function (width, height) {
